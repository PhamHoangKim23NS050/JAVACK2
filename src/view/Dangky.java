...
public class Dangky extends JFrame {
	...
	public Dangky() {
		...
		jbtSignup.setBackground(new Color(255, 240, 245));
		jbtSignup.setForeground(Color.BLACK);
		jbtSignup.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\registered.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\verify.png"));
		lblNewLabel_1.setBounds(266, 11, 74, 72);
		contentPane.add(lblNewLabel_1);
		
		JCheckBox chckbxhienthimk = new JCheckBox("Hiển thị mật khẩu");
		chckbxhienthimk.setBackground(new Color(240, 255, 255));
