...
public class login extends JFrame implements ActionListener{
	...
	public login() {
		...
		lbllogin.setBounds(346, 28, 113, 44);
		...
		btndangnhap.setBackground(new Color(255, 240, 245));
		btndangnhap.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\login.png"));
		...
		btndangky.setBackground(new Color(255, 240, 245));
		btndangky.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\verify.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\login (1).png"));
		lblNewLabel_1.setBounds(277, 28, 71, 57);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\lock (1).png"));
		lblNewLabel_2.setBounds(31, 192, 65, 57);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\user (3).png"));
		lblNewLabel_3.setBounds(31, 110, 65, 71);
		contentPane.add(lblNewLabel_3);
		
		JCheckBox chckbxhienmk = new JCheckBox("Hiện mật khẩu");
		chckbxhienmk.setBackground(new Color(240, 248, 255));
