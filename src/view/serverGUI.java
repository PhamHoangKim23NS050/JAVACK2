...
public class serverGUI extends JFrame {
	...
	public serverGUI() {
		...
		thongtinserver.setBackground(new Color(240, 255, 255));
		...
		btnStartServer.setIcon(new ImageIcon(serverGUI.class.getResource("/image/start.png")));
		...
		btnStopServer.setBackground(new Color(255, 255, 255));
		btnStopServer.setIcon(new ImageIcon(serverGUI.class.getResource("/image/stop.png")));
		...
		txtMessage.setBackground(new Color(230, 230, 250));
		...
		lblserverimg.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\server.png"));
