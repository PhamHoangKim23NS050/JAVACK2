...
public class mainGUI extends JFrame implements WindowListener {
	...
	public mainGUI() throws Exception {
		...
		lblchatclient.setForeground(new Color(0, 0, 0));
		...
		listActive.setBackground(new Color(230, 230, 250));
		...
		thongtinserver.setBackground(new Color(216, 191, 216));
		...
		btnSaveServer.setIcon(new ImageIcon("C:\\Users\\phamh\\OneDrive\\Máy tính\\imagejava\\diskette.png"));
